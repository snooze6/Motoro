...
//     for (int i=0; i<1; i++){
//        listaEsferas.add(new Esfera(new Vector(-400-100, 0+11, -220), new Vector(-0.0f,-0.0f,-0.0f), 20, 10));
////          col.add(listaEsferas.get(i));
//     }

        for (int i=0; i<10; i++){
            listaEsferas.add(new Esfera(new Vector(-400-50*i, 0+11, -220), new Vector(-0.3f,-0.0f,-0.0f), 20, 10));
        }
...
//
       ...
       aba = new Plano(-1,1,0 , -400, 0  , -400, 400);
       arr = new Plano(1,1,0, -400, 400, -400, 400);

        der = new Plano(1,1,0 , -600, 0  , -200, 400);
        izq = new Plano(-1,1,0, -600, 400, -200, 400);
